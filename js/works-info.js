const nowadays = {
    title: "Nowadays,",
    type: 'type: project',
    text: 'Nowadays,는 개인 맞춤형 문화 큐레이팅 기반 앱 서비스 입니다. </br> 서비스 기획과 앱 서비스 / 웹 페이지 디자인에도 참여하였으며, </br> 웹 페이지와 프로모션 영상 작업에도 참여 하였습니다.',
...
const remain = {
    title: "Remain, Re-main",
    type: 'type: branding, website',
    text: '계원예술대학교의 2020년 졸업 전시회의 <br>     브랜딩 및 웹사이트 제작 프로젝트입니다. <br> 졸업 전시 작품을 전시하는 목적으로 제작 되었으며<br> 아이덴티티인 픽셀을 활용하여 다시 주인공이 되는, 계속 되는 학생들의 여정을 표현했습니다.',
...
const werk = {
    title: "werk",
    type: 'type: web site',
    text: '카페 브랜드 Werk의 웹페이지 리뉴얼 작업입니다. <br> 브랜드의 특성을 고려해 모던하면서도 감각적인 느낌의 웹페이지 디자인을 진행하였고, <br> JavaScript를 통한 인터렉션이 포함 된 웹 구현 작업을 진행하였습니다.',
...
const ilmin = {
    title: "Ilmin Museum",
    type: 'type: web site',
    text: '일민미술관의 웹페이지 리뉴얼 작업입니다. <br>컨셉 기획과 웹페이지 디자인, 구현까지의 작업을 진행하였습니다. <br> 일민 미술관의 초성을 심볼로 이용하며 현재 전시페이지와 미술관 소개 페이지를 나눠 구성하였습니다.',
...
const ff = {
    title: "feel free",
    type: 'type: video',
    text: '가수 LANA DEL REY의 음악 RIDE 의 프로모션 비디오입니다. <br> 음악이 가지는 자유로운 분위기와 해방감을 주제로 작업하였으며, <br> 일러스트를 한 장 한장 이어서 제작했습니다.',
...
const no = {
    title: "Newtro Outfitters",
    type: 'type: video',
    text: '브랜드 Urban Outfitters 의 가상 기간 한정 프로모션 <br> "Newtro Outfitters"를 홍보하기 위한 온라인 브로셔 제작 작업입니다. <br> 한정판 LP를 소개하는 컨텐츠로 구성되었으며, <br> Newtro한 컨셉에 맞는 장난스러운 그래픽으로 젊은 느낌을 강조했습니다.', 
